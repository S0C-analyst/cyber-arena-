# CyberArena — SOC Automation Platform (XDR/SIEM + SOAR)
...
### Part 1 — Wazuh XDR/SIEM Deployment
...
3. **XDR & External Integrations** — enriching alerts with VirusTotal (file hash reputation) and AbuseIPDB (IP reputation) via a custom Python integration script.
...
- [`Wazuh_XDR_SIEM_SOC_Guide.docx`](./Wazuh_XDR_SIEM_SOC_Guide.docx) — full XDR/SIEM deployment & operations guide
